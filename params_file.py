...
num_genes = 5
seq_length = 100 # Will be automatically adjusted to the closest number that's a multiple of 3, to have complete codons.
prop_unlinked = 0.7
...
seq_mutation_rate = 0.0001	# Mutation likelihood per base, per generation.  Ex:
